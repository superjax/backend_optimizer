...
if __name__ == '__main__':
    ...
    plt.savefig("plots/noisy_edges_hist" + str(results['num_robots']) + ".pdf", bbox_inches='tight', pad_inches=0)
    ...
    #     ax.axis('square')
    #     ax.legend()
    #     plt.savefig("plots/noisy_edges_traj" + str(j).zfill(3) + ".pdf", bbox_inches='tight', pad_inches=0)
